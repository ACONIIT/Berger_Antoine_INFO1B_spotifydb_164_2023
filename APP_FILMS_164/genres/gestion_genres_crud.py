        ...
        try:
            with DBconnection() as mc_afficher:
                if order_by == "ASC" and id_genre_sel == 0:
                    strsql_genres_afficher = """SELECT * FROM t_tags"""
                    ...
                    strsql_genres_afficher = """SELECT * FROM t_tags WHERE id_tags = %(value_id_genre_selected)s"""
                ...
                if not data_genres and id_genre_sel == 0:
                    ...
                    flash(f"Le Tag demandé n'existe pas !!", "warning")
                else:
                    # Dans tous les autres cas, c'est que la table "t_genre" est vide.
                    # OM 2020.04.09 La ligne ci-dessous permet de donner un sentiment rassurant aux utilisateurs.
                    flash(f"Données Tags affichés.", "success")
...
def genre_update_wtf():
    ...
    try:
        ...
        if form_update.validate_on_submit():
            ...
            str_sql_update_intitulegenre = """UPDATE t_tags SET tag = %(value_name_genre)s, 
            date_ins_tag = %(value_date_genre_essai)s WHERE id_tags = %(value_id_genre)s """
            with DBconnection() as mconn_bd:
            ...
            str_sql_id_genre = "SELECT id_tags, tag, date_ins_tag FROM t_tags " \
                               "WHERE id_tags = %(value_id_genre)s"
            ...
            form_update.nom_genre_update_wtf.data = data_nom_genre["tag"]
            form_update.date_genre_wtf_essai.data = data_nom_genre["date_ins_tag"]
    ...
    try:
        ...
        if request.method == "POST" and form_delete.validate_on_submit():
            ...
            if form_delete.submit_btn_conf_del.data:
                ...
                flash(f"Effacer le tag de façon définitive de la BD !!!", "danger")
            ...
            if form_delete.submit_btn_del.data:
                ...
                str_sql_delete_films_genre = """DELETE FROM t_son_avoir_tags WHERE fk_tags = %(value_id_genre)s"""
                str_sql_delete_idgenre = """DELETE FROM t_tags WHERE id_tags = %(value_id_genre)s"""
                ...
                flash(f"Tag définitivement effacé !!", "success")
                print(f"Tag définitivement effacé !!")
